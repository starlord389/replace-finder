-- Investor workspace: preferences, saved properties, listing inquiries,
-- shared-inventory privacy hardening, and owner demo access.
...
-- Demo inventory is visible only to admins. Preserve the hardened
-- security-invoker-view -> SECURITY DEFINER function architecture introduced
-- in 20260730192359, and apply the new condition inside the protected function.
...
-- The owner can switch among Admin, Agent, and Investor without a second login.
INSERT INTO public.user_roles (user_id, role)
