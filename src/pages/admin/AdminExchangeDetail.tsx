...
function ExchangeSummaryCard({ exchange }: { exchange: Tables<"exchanges"> }) {
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2 text-base"><Clock className="h-4 w-4 text-primary" /> Exchange status and tax timeline</CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <dl className="grid gap-3 sm:grid-cols-2">
          ...
          <Info label="Identification deadline">{fmtDate(exchange.identification_deadline)}</Info>
          <Info label="Closing deadline">{fmtDate(exchange.closing_deadline)}</Info>
