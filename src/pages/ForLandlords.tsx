...
const FL_STYLE = `
  ...
  [data-landing] .fl-card-ic { width: 46px; height: 46px; border-radius: 13px; background: #f1ece3; color: #1d1d1d; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 18px; }
