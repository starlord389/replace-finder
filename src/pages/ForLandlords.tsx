...
const TRUST_POINTS = [
  ...
  {
    title: "Free for agents and investors",
    body: "Agents and investors both use 1031ExchangeUp™ free. The introduction costs you nothing and commits you to nothing, so our advice has no angle on you.",
  },
