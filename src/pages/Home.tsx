...
const BADGES = [
  ...
  { txt: ["Continuous Monitoring", <span key="iq">with <span style={{ color: "#43a047" }}>Exchange IQ™</span></span>], svg: (<svg viewBox="0 0 24 24" fill="none"><rect x="7" y="7" width="10" height="10" rx="2.5" stroke="currentColor" strokeWidth="1.8" /><rect x="10" y="10" width="4" height="4" rx="1" fill="currentColor" /><path d="M10 4v2M14 4v2M10 18v2M14 18v2M4 10h2M4 14h2M18 10h2M18 14h2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>) },
    ...
    <section className="nb-hero">
      ...
      <div className="nb-hero-inner mx-auto max-w-[1240px] px-5 py-16 text-center sm:px-8 lg:py-24">
        <h1 className="nb-hero-h1 mx-auto max-w-[720px]">
          The biggest obstacle to a 1031 Exchange is finding a replacement property. We’ve solved that.
        </h1>
