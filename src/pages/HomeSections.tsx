      ...
      <div className="nb-diff-devices" aria-hidden="true">
          ...
          <div className="nb-diff-laptop-screen">
            ...
            <div className="nb-diff-mock-row">
              ...
              <div className="nb-diff-mock-lines">
                <div className="nb-diff-mock-name">Cedar Point Industrial</div>
                <div className="nb-diff-mock-loc">Reno, NV &middot; $3.1M</div>
              </div>
              <div className="nb-diff-mock-score">94%</div>
            </div>
            <div className="nb-diff-mock-row">
              <div className="nb-diff-mock-thumb" />
              <div className="nb-diff-mock-lines">
                <div className="nb-diff-mock-name">Stonebridge Flex Park</div>
                <div className="nb-diff-mock-loc">Boise, ID &middot; $3.1M</div>
              </div>
              <div className="nb-diff-mock-score">91%</div>
            </div>
            <div className="nb-diff-mock-row">
              <div className="nb-diff-mock-thumb" />
              <div className="nb-diff-mock-lines">
                <div className="nb-diff-mock-name">Harbor Logistics Center</div>
                <div className="nb-diff-mock-loc">Tucson, AZ &middot; $2.9M</div>
              </div>
              <div className="nb-diff-mock-score">88%</div>
            </div>
          </div>
        ...
        <div className="nb-diff-phone">
          ...
          <div className="nb-diff-mock-row">
            ...
            <div className="nb-diff-mock-lines">
              <div className="nb-diff-mock-name">Cedar Point Industrial</div>
              <div className="nb-diff-mock-loc">Reno, NV</div>
            </div>
            <div className="nb-diff-mock-score">94%</div>
          </div>
          <div className="nb-diff-mock-row">
            <div className="nb-diff-mock-thumb" />
            <div className="nb-diff-mock-lines">
              <div className="nb-diff-mock-name">Stonebridge Flex</div>
              <div className="nb-diff-mock-loc">Boise, ID</div>
            </div>
            <div className="nb-diff-mock-score">91%</div>
          </div>
          <div className="nb-diff-mock-row">
            <div className="nb-diff-mock-thumb" />
            <div className="nb-diff-mock-lines">
              <div className="nb-diff-mock-name">Harbor Logistics</div>
              <div className="nb-diff-mock-loc">Tucson, AZ</div>
            </div>
            <div className="nb-diff-mock-score">88%</div>
          </div>
        </div>
