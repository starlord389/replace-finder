...
function Sec_meet() {
  return (
<section id="meet">
  <div className="max-w-[1240px] mx-auto px-5 sm:px-8 py-16 lg:py-24">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">

      <div className="max-w-xl">
        <span className="nb-eyebrow">MEET</span>
        <h2 className="nb-h2 mt-3">Meet 1031Exchange<span style={{ color: '#43a047' }}>Up</span></h2>
...
function Sec_who() {
  return (
<section id="who" data-nb className="w-full py-16 sm:py-20" style={{ background: "#ffffff" }}>
  <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
    <div className="nb-who-head">
      <p className="nb-eyebrow">Who We Serve</p>
      <h2 className="nb-h2">Who It's Built For</h2>
      <p className="nb-lead">One platform, three ways to win — whether you list, own, or invest.</p>
    </div>
...
function Sec_why() {
  return (
<section id="why" className="px-5 sm:px-8 py-16 sm:py-20">
  <div className="mx-auto" style={{ maxWidth: 1240 }}>
    <div className="nb-why-wrap px-6 sm:px-12 lg:px-16 py-14 lg:py-20">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        {/* RIGHT — ROE calculator card */}
        <div className="nb-why-card">
          <h3 className="nb-why-card-title">Is Your Equity Working Hard Enough?</h3>
          <p className="nb-why-card-sub">
            In about 20 seconds we'll estimate whether exchanging into a larger
            investment property could improve your return on equity.
          </p>

          <div className="nb-why-inputs">
            <div className="nb-why-field">
              <label className="nb-why-label" htmlFor="nb-why-cv">Current Property Value</label>
              <div className="nb-why-input">
                <span className="nb-why-dollar">$</span>
                <input id="nb-why-cv" type="text" defaultValue="1,000,000" inputMode="numeric" />
              </div>
            </div>

            <div className="nb-why-field">
              <label className="nb-why-label" htmlFor="nb-why-ni">Current Net Income</label>
              <div className="nb-why-input">
                <span className="nb-why-dollar">$</span>
                <input id="nb-why-ni" type="text" defaultValue="60,000" inputMode="numeric" />
              </div>
            </div>

            <div className="nb-why-field">
              <label className="nb-why-label" htmlFor="nb-why-nv">Est. New Property Value</label>
              <div className="nb-why-input">
                <span className="nb-why-dollar">$</span>
                <input id="nb-why-nv" type="text" defaultValue="1,500,000" inputMode="numeric" />
              </div>
            </div>
          </div>

          <button type="button" className="nb-why-calc">Calculate My ROE</button>
        </div>
      </div>
    </div>
  </div>
...
function Sec_diff() {
  return (
<section id="different" className="w-full bg-white py-16 sm:py-20" data-nb>
  <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
    <div className="text-center mb-12 sm:mb-16">
      <p className="nb-eyebrow">The Difference</p>
      ...
      <div className="nb-diff-devices" aria-hidden="true">
        ...
        <div className="nb-diff-laptop">
          <div className="nb-diff-laptop-screen">
            ...
            <div className="nb-diff-mock-row">
              <div className="nb-diff-mock-thumb" />
              <div className="nb-diff-mock-lines">
                <div className="nb-diff-ml" />
                <div className="nb-diff-ml short" />
              </div>
              <div className="nb-diff-mock-pill" />
            </div>
            <div className="nb-diff-mock-row">
              <div className="nb-diff-mock-thumb" />
              <div className="nb-diff-mock-lines">
                <div className="nb-diff-ml" />
                <div className="nb-diff-ml tiny" />
              </div>
              <div className="nb-diff-mock-pill" />
            </div>
            <div className="nb-diff-mock-row">
...
function Sec_resources() {
  return (
<section id="resources" className="w-full" style={{ background: '#eef3fb' }}>
  <div className="mx-auto" style={{ maxWidth: 1240 }}>
    <div className="px-5 sm:px-8 py-16 sm:py-20">
      <div className="text-center" style={{ marginBottom: 48 }}>
        <div className="nb-eyebrow">Resources</div>
        <h2 className="nb-h2">Learn, connect, and get in early</h2>
        <p className="nb-lead mx-auto" style={{ maxWidth: 640 }}>
          Everything you need to understand 1031 exchanges — plus the people and the platform behind it.
        </p>
      </div>
      ...
      <div className="nb-res-grid">
        ...
        <div className="nb-res-card">
          ...
          <div className="nb-res-experts">
            ...
            <div className="nb-res-expert">
              <div className="nb-res-avatar">EY</div>
              <div>
...
function Sec_faqcta() {
  return (
<section id="faq" className="w-full px-5 sm:px-8 py-16 sm:py-20" style={{ background: '#eef3fb' }}>
  <div className="mx-auto" style={{ maxWidth: '1240px' }}>
    <div className="nb-fct-wrap">

      {/* (A) Heading */}
      <div className="nb-fct-head">
        <div className="nb-eyebrow">Got Questions?</div>
        <h2 className="nb-h2">Frequently Asked Questions</h2>
        <p className="nb-lead">Everything you need to know about getting started on 1031ExchangeUp.</p>
      </div>
      ...
      <div className="nb-fct-cta">
        ...
        <div className="nb-fct-cta-btns">
          ...
          <a href="#demo" className="nb-fct-btn nb-fct-btn-out">Schedule a Demo</a>
        </div>
