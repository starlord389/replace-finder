...
describe("public landing-page audiences", () => {
  it("leads with the continuous opportunity-monitoring value proposition", () => {
    expect(homeSource).toContain("Your Property Could Be");
    expect(homeSource).toContain("Making You More Money.");
    expect(homeSource).toContain("Register My Property — Free");
  ...
  it("explains agent and investor value without becoming an open marketplace", () => {
    expect(sectionsSource).toContain("An Intelligent Monitoring Network for Investment Real Estate.");
